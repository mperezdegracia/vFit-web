  ...
  >
    ...
    <vue-flip v-model="show">
      <template v-slot:front>
        <div>
          <v-img cover height="250" :src="routine.image"></v-img>
      ...
      <template v-slot:back>
        ...
        <div v-if="routine.cycles.length > 4" class="d-flex mr-10">
          <v-spacer></v-spacer>
        ...
        <v-card-actions>
          <v-btn color="primary" variant="tonal" class="btn-start" @click="edit"
            >Edit</v-btn
          >
          <v-btn
            color="red"
